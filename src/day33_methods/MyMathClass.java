...
public class MyMathClass {
    ...
    public static void division(double numOne, double numTwo) {
        if (numTwo != 0) {
            ...
            System.err.println("Cannot divide by 0"); // err makes the output red
        }
    }
    ...
    public static void main(String[] args) {
        add(4.5, 6.1);
        add(4, 5);
      // int a = add(3.4, 12.2); we cannot assign anything, because our methods are void, there is no return value. it only does the action
